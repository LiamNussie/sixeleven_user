                ...
                <div className="flexo">
                    ...
                    <div className="right">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="input">
                                <label>Parent/Guardian <span style={{color: "crimson"}}>*</span></label><br />
                                <input onChange={e => setGuardian(e.target.value)} placeholder='guardian’s full name' type="text" />
                            </div>
                            <div className="input">
                                <label>Parent/Guardian’s Phone Number <span style={{color: "crimson"}}>*</span></label><br />
                                <input minLength={11} maxLength={11} onChange={e => setGuardianNo(e.target.value)} type="tel" placeholder="guardians's phone number" />
                            </div>
                            <div className="input">
                            ...
                            <div className="input">
                                <label>Highest class level attended <span style={{color: "crimson"}}>*</span></label><br />
                                <input type="text" onChange={e => setCLevel(e.target.value)} />
                                {/* <select onChange={e => setEdu(e.target.value)}>
                                    <option selected disabled>Select</option>
                                    <option value="ssce">SSCE</option>
                                    <option value="hnd">HND</option>
                            ...
                            <div className="input">
                                <label>When last were you in school? <span style={{color: "crimson"}}>*</span></label><br />
                                <input onChange={e => setSchLast(e.target.value)} type="date" />
                            </div>
                            {/* <div className="input">
                            ...
                            <div className="input">
                                ...
                                <input minLength={11} maxLength={11} onChange={e => setPhone(e.target.value)} type="tel" placeholder="referee's phone number" />
                            </div>
                            <div className="input">
                                <label>Referee’s Email</label><br />
                                <input onChange={e => setPhone(e.target.value)} type="tel" placeholder="referee's email" />
                            </div>
