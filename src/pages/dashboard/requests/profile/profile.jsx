    ...
    <div className="profile">
      ...
      <div className="boxes">
        ...
        <div className="righti">
          <div className="img" style={{ backgroundImage: `url(${data?.userId?.image})` }}></div>
          <div className="bio">
            <p className="title">Bio-Data</p>
            <div className="pt">
              <span className="label">Full Name:</span>
              <span className="val valx">{data?.userId?.name}</span>
            </div>
            <div className="pt">
              <span className="label">Gender:</span>
              <span className="val">{data?.userId?.gender}</span>
            </div>
            <div className="pt">
              <span className="label">D.O.B:</span>
              <span className="val">{data?.userId?.dateOfBirth}</span>
            </div>
          </div>
          <div className="contact">
            ...
            <div className="pt">
              ...
              <span className="val">{data?.userId?.phoneNo}</span>
            </div>
            <div className="pt">
              <span className="label">
                <svg
              ...
              <span className="val">{data?.userId?.email}</span>
            </div>
          </div>
          <div className="res">
            ...
            <div className="pt">
              ...
              <span className="val">{data?.userId?.stateOfResidence}</span>
            </div>
            <div className="pt">
              <span className="label">L.G.A:</span>
              <span className="val">{data?.userId?.localGovt}</span>
            </div>
            <div className="pt">
              <span className="label">Address:</span>
              <span className="val">{data?.userId?.address}</span>
            </div>
            <div className="pt">
