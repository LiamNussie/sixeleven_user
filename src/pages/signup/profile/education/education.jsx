...
const Education = ({data}) => {
    ...
    const {streetHawkerInfo} = currentUser
    return (
        <div className="education">
            <div className="first">
                <div className="pt">
                    <p className="label">Highest academic Level</p>
                    <p className="val">{streetHawkerInfo?.educationLevel}</p>
                </div>
                <div className="pt">
                    <p className="label">Highest class attended</p>
                    <p className="val">{streetHawkerInfo?.classLevel}</p>
                </div>
                <div className="pt">
                    <p className="label">Last time in school as at when application was last filled</p>
                    <p className="val">{streetHawkerInfo?.dateInSch}</p>
                </div>
            </div>
            <div className="secio">
                    ...
                    <div className="files">
                        <div className="filex">
                            ...
                            <div className="txt">
                                <p className="top">Certification.pdf</p>
                                <p className="bottom">{moment().calendar(streetHawkerInfo?.updatedAt)}</p>
                            </div>
                            </div>
